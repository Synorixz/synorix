...
{
    BOOST_CHECK(TestSplitHost("www.synorixcore.org", "www.synorixcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.synorixcore.org]", "www.synorixcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.synorixcore.org:80", "www.synorixcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.synorixcore.org]:80", "www.synorixcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.synorixcore.org:65536", "www.synorixcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.synorixcore.org:0", "www.synorixcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.synorixcore.org:", "www.synorixcore.org:", 0, false));
}
