...
extern thread_local ThreadContext g_thread_context; // NOLINT(synorix-nontrivial-threadlocal)
// Silence nonstandard synorix tidy error "Variable with non-trivial destructor
