...
/** Main Synorix application object */
class SynorixApplication: public QApplication
{
    Q_OBJECT
public:
    explicit SynorixApplication();
    ~SynorixApplication();
    ...
    /// Get window identifier of QMainWindow (SynorixGUI)
...
Q_SIGNALS:
    ...
    void windowShown(SynorixGUI* window);
