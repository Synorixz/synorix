...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = SynorixUnits::formatWithUnit(unit, amount, true, SynorixUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    SynorixUnit unit{SynorixUnit::SNRX};
...
{
    SynorixUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(SynorixUnits::formatWithPrivacy(unit, balances.balance, SynorixUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(SynorixUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, SynorixUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(SynorixUnits::formatWithPrivacy(unit, balances.immature_balance, SynorixUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(SynorixUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, SynorixUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("SNRX")
    updateDisplayUnit();
}
