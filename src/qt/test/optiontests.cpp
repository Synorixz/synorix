...
{
    // Test regression https://github.com/synorix/synorix/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/synorix-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/synorix-core/gui/pull/568.
    // With fListen=false in ~/.config/Synorix/Synorix-Qt.conf and all else left as default,
    // synorix-qt should set both -listen and -listenonion to false and start successfully.
