// Copyright (c) 2018-present The Synorix Core developers
...
//! Entry point for SynorixApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SynorixApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SynorixGUI tests.
void AppTests::guiTests(SynorixGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SynorixGUI::consoleShown, this, &AppTests::consoleTests);
