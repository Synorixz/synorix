      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->synorixAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->synorixAtStartup);
    ...
    ui->synorixAtStartup->setToolTip(ui->synorixAtStartup->toolTip().arg(CLIENT_NAME));
    ui->synorixAtStartup->setText(ui->synorixAtStartup->text().arg(CLIENT_NAME));

    ui->openSynorixConfButton->setToolTip(ui->openSynorixConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new SynorixUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->synorixAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSSNRXontrols);
...
void OptionsDialog::on_openSynorixConfButton_clicked()
{
