...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, SynorixUnits::SeparatorStyle separators=SynorixUnits::SeparatorStyle::STANDARD) const;
