...
/** Interface from Qt to configuration data structure for Synorix client.
...
public:
    ...
    SynorixUnit getDisplayUnit() const { return m_display_synorix_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSSNRXontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    SynorixUnit m_display_synorix_unit;
...
Q_SIGNALS:
    void displayUnitChanged(SynorixUnit unit);
