...
#include <algorithm>
#include <attributes.h> // Added for Synorix Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Synorix Core
#include <util/string.h> // Added for Synorix Core
...
// Added for Synorix Core. Similar to std::runtime_format from C++26.
...
// Added for Synorix Core. Wrapper for checking format strings at compile time.
